...
public:
	...
	int multi_tone_Msg3;// 0: not support; 1:support, Msg3:91 bits
	int mcs;//mcs Index
	int Qm;
	int round;//for retransmission parts
...
{
	srand(time(NULL));
	//delay reference in TR.45820
	int Gdelay=80+44;//SIB-2 decode time
	int RARdelay=0,Sdelay0=0,Pdelay=0,Sdelay1=0,Bdelay=0;
 ...
 //    	// printf("strerror(errno)=%s\n", strerror(errno));
	...
	//for each subframe in NPRACH period array sze
	int pcmax=23;
	...
	//New Arrival Process for UEs,Initialization for DV UEs
